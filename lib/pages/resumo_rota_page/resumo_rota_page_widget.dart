...
class ResumoRotaPageWidget extends StatefulWidget {
  const ResumoRotaPageWidget({super.key});

  @override
  State<ResumoRotaPageWidget> createState() => _ResumoRotaPageWidgetState();
}
...
class _ResumoRotaPageWidgetState extends State<ResumoRotaPageWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ResumoRotaPageModel());
  }
